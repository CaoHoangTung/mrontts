...
import VinSTTNorm.asrnormalizer.abstractentity.BinarySetBaseEntity;
...
public class BinaryProperNameMapEntity extends BinarySetBaseEntity {
    Set<Integer> properNameSet;
    public BinaryProperNameMapEntity(JSONObject config) {
        super(config);
        this.init();
    }
