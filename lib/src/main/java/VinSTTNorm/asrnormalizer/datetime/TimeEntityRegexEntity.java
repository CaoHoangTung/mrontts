package VinSTTNorm.asrnormalizer.datetime;
...
public class TimeEntityRegexEntity extends SimpleRegexEntity {
    private static String TAG = "TIME_ENTITY";

    public TimeEntityRegexEntity(JSONObject config) {
        super(config);
    }
