...
public class SerialDigitNumberFSTEntity extends NumberFSTEntity {
    private static String TAG = "SERIAL_DIGIT_NUMBER_ENTITY";
    private final int MIN_TOKEN_COUNT = 7;

    public SerialDigitNumberFSTEntity(JSONObject config) {
        super(config);
    }
