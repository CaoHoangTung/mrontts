...
public class FSTShortNumberExtractor extends FSTNumberExtractor{
    private static String TAG = "short_number_extractor";

    public FSTShortNumberExtractor(JSONObject config){
        super(config);
    }
